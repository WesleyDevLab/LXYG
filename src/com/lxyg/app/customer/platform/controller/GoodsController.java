...
//	
	...
	public void loadGoodsAttribute(){
		Object [] obj=new Object[]{};
		String sql="select id,name,create_time,img from kk_product_type";
		String sql1="select id,name,img,p_type_id,p_type_name from kk_product_brand ";
		...
		if(getParaToInt("typeId")!=null&&getParaToInt("typeId")!=0){
			sql1+=" where p_type_id=?";
			obj=new Object[]{getPara("typeId")};
		}
		List<Record> type= Db.find(sql);
		List<Record> brand= Db.find(sql1, obj);
