...
<body>
	...
	<h1 class="tittle">添加会员卡</h1>
	<div class="con">
		<table width="600" border="0" cellspacing="0" cellpadding="0" class="ad_car">
			<tr>
				<td align="right"><span class="span_font">会员卡名称：</span></td>
				<td>
					<input name="cardname_text" id="cardname_text" type="text" class="inp_bor" />
				</td>
			</tr>
			<tr>
				<td align="right"><span class="span_font">该会员卡提供折扣:</span></td>
				<td>
					<input name="discount_text" id="discount_text" type="text" class="inp_bor_short" /> 折<span class="hui">（只可输入数字和小数点，范围在（0-10），例如7.5折请输入数字7.5）</span>
				</td>
			</tr>
			<tr>
				<td align="right"><span class="span_font">需要累计消费:</span></td>
				<td>
					<input name="request_text" id="request_text" type="text" class="inp_bor_short" /> 金额即可领取 <span class="hui">（只可输入数字和小数点）</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea name="instruction_text" id="instruction_text" cols="45" rows="5" class="benzhu"></textarea>
				</td>
			</tr>
			<tr>
				<td align="right"><span class="span_font">注意事项：</span></td>
				<td>
					<textarea name="textarea" name="note_text" id="note_text" cols="45" rows="5" class="benzhu"></textarea>
				</td>
			</tr>
			<tr>
				<td align="right"><span class="span_font">会员卡描述：</span></td>
				<td>
					<textarea name="remark_text" id="remark_text" cols="45" rows="5" class="benzhu"></textarea>
				</td>
			</tr>
			<tr>
				<td></td>
				<td>
					<form action="<%=basePath%>card/add" id="add_ajax" method="post">
