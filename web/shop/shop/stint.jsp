...
<body>
	<div class="position">
		<img src="<%=basePath%>shop/images/pimg.png" width="18" height="51" />您当前的位置：结算记录
	</div>
	<h1 class="tittle">结算记录</h1>
	<div class="con">
		...
		<div class="btn_sx"> 
			<ul>
				<c:if test="${type==0}">
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=2')">全部</a></li>
					<li class="frist"><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=0')">未结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=1')">已结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=3')">在线付</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=4')">到店付</a></li>
				</c:if>
				<c:if test="${type==1}">
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=2')">全部</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=0')">未结算</a></li>
					<li class="frist"><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=1')">已结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=3')">在线付</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=4')">到店付</a></li>
				</c:if>
				<c:if test="${type==2}">
					<li class="frist"><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=2')">全部</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=0')">未结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=1')">已结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=3')">在线付</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=4')">到店付</a></li>
				...
				<c:if test="${type==3}">
					...
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=0')">未结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=1')">已结算</a></li>
					<li class="frist"><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=3')">在线付</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=4')">到店付</a></li>
				</c:if>
				<c:if test="${type==4}">
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=2')">全部</a></li>
					...
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=1')">已结算</a></li>
					<li><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=3')">在线付</a></li>
					<li class="frist"><a href="javascript:void(0)" onclick="toUrl('<%=basePath%>shop/stint4Shop?type=4')">到店付</a></li>
				</c:if>
			</ul>
		</div>
