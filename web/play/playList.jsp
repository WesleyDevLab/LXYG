...
function loadData(page,brandId,typeId,proName){
    ...
    console.info("--"+index_search);

    if(index_search==null || index_search==""){
        index_search="bz";
    }
    $.post(url,{"pg":page,"brandId":brandId,"typeId":typeId,"index_search":index_search,"proName":proName},function(result){
       if(result.code==10010){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="btn-group" id="brand">
                                        <button class="btn btn-default btn-sm dropdown-toggle" type="button" data-toggle="dropdown">
                                            品牌筛选<span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu" role="menu" id="brand_search" >
                                            <li><a href="javascript:void(0);" value="0" onclick="searchByBrand($(this))">全部</a></li>
                                        </ul>
                                    </div>

                                    <div class="btn-group" id="type">
                                        <button class="btn btn-default btn-sm dropdown-toggle" type="button" data-toggle="dropdown">
                                            类型筛选<span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu" role="menu" id="type_search" >
                                            <li><a href="javascript:void(0);" value="0" onclick="searchByType($(this))" >全部</a></li>
                                        </ul>
                                    </div>

                                 <input type="text" style="margin-left: 100px" id="search_pros" ><button style="margin-left: 5px" type="button" onclick="search()"  class="btn btn-primary">搜索</button>
                                </div>
							</div>
