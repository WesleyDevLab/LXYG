		...
		<div class="row-fluid">
			<div class="box span12">
				<div class="box-header">
					<h2>
						<i class="icon-edit"></i>添加资讯
					</h2>
				</div>
				<div class="box-content">
					<form class="form-horizontal" id="news_ajax" enctype="multipart/form-data" action="${path}/forum/add" method="post" />
					<fieldset>
						<div class="control-group">
							<label class="control-label" for="typeahead">分类名称：</label>
							<div class="controls">
								<input type="text" name="forum.fname" id="fname1"  onfocus="foucu(this.value);" class="span6 typeahead" />
							</div>
						</div>
						<div class="control-group">
					...
					<option value="0">无</option>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="forum.url" id="url1"  class="span6 typeahead" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="typeahead">排序：</label>
							<div class="controls">
								<input type="text" name="forum.orderby" id="orderby1" onkeyup="this.value=this.value.substring(0,36)" class="span6 typeahead" />
							</div>
						</div>
					<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" rows="8" cols="30" name="forum.content" id="content1"  class="span6 typeahead" />
							</div>
						</div>
