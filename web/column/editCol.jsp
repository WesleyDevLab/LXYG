	...
	if (cname == "") {
		...
		/* $("#add").ajaxSubmit(
		{
			...
			success : function(msg) {
				if (msg == "0") {
					alert("添加成功！");
					location.href = "${path}/column/list?parentId=${parentId}&resParId=${resParId}";
				} else {
		...
		<div class="row-fluid">
			<div class="box span12">
				...
				<div class="box-content">
					<form class="form-horizontal" id="add" action="${path }/column/edit" method="post" enctype="multipart/form-data" />
						<fieldset>
